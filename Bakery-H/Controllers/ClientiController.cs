...
namespace Bakery_H.Controllers
{
    public class ClientiController : Controller
    {
        ...
        public ClientiController(BakeryDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdClient,Nume,Prenume,Adresa,Email,NumarTelefon")] Clienti clienti)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdClient,Nume,Prenume,Adresa,Email,NumarTelefon")] Clienti clienti)
        {
